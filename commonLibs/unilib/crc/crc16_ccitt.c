...
//=============================================================================
static uint_fast16_t crc16_ccitt_update(uint_fast16_t crc, uint_fast8_t data)
{
...
uint16_t crc16_ccitt_append(uint_fast16_t crc, const void* buf, size_t len)
{
    ...
    while (len--)
	{
		crc = crc16_ccitt_update(crc, *ptr++);
	}
...
uint16_t crc16_ccitt(const void* buf, size_t len)
{
	return (crc16_ccitt_append((uint_fast16_t)-1, buf, len));  // initial 0xffff
}

...
uint8_t led_map_set_pixel(uint8_t x, uint8_t y, leds this_leds)
{
	...
	my_map.my_leds[led_number].red 	 =	this_leds.red  * 0.90;
	my_map.my_leds[led_number].green =	this_leds.green   * 0.90 * 0.90;
	my_map.my_leds[led_number].blue  =	this_leds.blue * 0.90 * 0.90; //// �� ���� ��������� �����������, ���������� ����� ���  � ����
	return 0;
}
//================================================================================

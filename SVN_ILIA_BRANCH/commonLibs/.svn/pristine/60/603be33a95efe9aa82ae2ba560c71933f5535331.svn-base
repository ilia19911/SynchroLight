...
// UBX_DATA_RATE - Частота посылок 1 у.е. = 0.1 Гц
#define UBX_DATA_RATE															40

// На какие выходные порты модуль должен отправлять данные.
//		0 - выход выключен
//		1 - выход включен
#define UBX_HW_I2C_OUTPUT													0
#define UBX_HW_UART1_OUTPUT												1
#define UBX_HW_UART2_OUTPUT												0
#define UBX_HW_USB_OUTPUT													0
#define UBX_HW_SPI_OUTPUT													0
/* ========================================================================== */	

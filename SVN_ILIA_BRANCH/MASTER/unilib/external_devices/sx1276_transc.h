...
#define MAX_PAYLOAD_SIZE										((uint8_t)0x20)		// Максимальный размер пакета передаваемый/принимаемый трансивером
/* ======================================================================	*/
...
/* ======================================================================	*/
/* Общие структуру для трансивера sx1276																	*/
/* ======================================================================	*/
typedef enum
{
	SX1276_STATE_IDLE,
...
typedef struct 
{
	...
	GPIO_TypeDef *CS_PORT;
	uint32_t CS_Pin;
	sx1276_osctype_t oscType;
	sx1276_band_t band;
	uint32_t frequency;
	sx1276_outputPin_t outputPin;
	uint8_t maxPower; 													// 0 - 7 (10.8 - 15 dBm, step 0.6 dBm)
	uint8_t outputPower;												// 0 - 15 (Pmax - (15 - REGVALUE) dBm)
	sx1276_bandwidth_t bandWidth;
	sx1276_error_code_t errorCodeRate;
	sx1276_header_t headerType;
	uint8_t spreadingFactor;										// 6 - 12
	sx1276_crc_t crcPayload;
...
typedef struct
{
	...
	sx1276_regs confRegs;
	sx1276_receiver_t receiver;
} sx1276_LoRa_Modem;
/* ======================================================================	*/

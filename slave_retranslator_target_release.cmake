...
## ------- TARGET STARTS HERE -------
set(TARGET_NAME slave_retranslator_target_release)
set(EXEC_NAME slave_retranslator_target_release_STM32F103CB)
add_executable(${EXEC_NAME})

set(MCU STM32F103CB)
target_compile_definitions(${EXEC_NAME} PRIVATE USE_STDPERIPH_DRIVER SLAVE HSE_VALUE=16000000  STM32F10X_MD SLAVE_RETRANSLATOR)
...
set(COMPILE_FLAGS -gdwarf-2 -Os -flto -mcpu=cortex-m3 -mthumb -mfloat-abi=soft  -mno-thumb-interwork -v) 
...
set	(GROUP_SRC_LEDS
		../commonLibs/leds/effect_processor.c
		../commonLibs/leds/led_maping.c
		../commonLibs/leds/player.c
		../commonLibs/leds/scen_memory.c
		../commonLibs/leds/ws2812b.c
	)

...
void        set_symbol(Display *structure, char new_symb, int number);
void        get_symbol(Display *structure, char new_symb, int number);
void        set_string(Display *structure, char new_symb[], int number);
void        get_string(Display *structure, char new_symb[], int number);

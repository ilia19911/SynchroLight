...
#define GREEN_LED_POW 0.6517f //пропорциональное изменение мощности зеленого цвета
#define BLUE_LED_POW 0.6455317f //пропорциональное изменение мощности синего цвета

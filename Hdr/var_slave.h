...
#define RED_LED_POW 1.0f //пропорциональное изменение мощности красного цвета
#define GREEN_LED_POW 0.894f //пропорциональное изменение мощности зеленого цвета
#define BLUE_LED_POW 0.803f //пропорциональное изменение мощности синего цвета

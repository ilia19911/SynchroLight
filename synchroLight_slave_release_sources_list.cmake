...
## ------- TARGET STARTS HERE -------
set(TARGET_NAME synchroLight_slave_release)
set(EXEC_NAME synchroLight_slave_release_STM32F103CB)
add_executable(${EXEC_NAME})

set(MCU STM32F103CB)
target_compile_definitions(${EXEC_NAME} PRIVATE USE_STDPERIPH_DRIVER  HSE_VALUE=16000000  STM32F10X_MD  NDEBUG)
...
set(COMPILE_FLAGS -Os -flto  -mcpu=cortex-m3 -mthumb -mfloat-abi=soft  -mno-thumb-interwork -v)
